<div class="form-group row">
	<div class="card-header">
		...
		<select name="daftar_vote" id="daftar_vote" class="form-control" onchange="DaftarVote(this.value)">
			...
			where a.flag_id='1' and a.status_id='1' and (now() BETWEEN a.tanggal_mulai and a.tanggal_selesai) and b.id_pemilih=" . $data_id;
			//echo $sql;
...
?>
	...
	case '0': ?>
		...
		<div class="alert alert-info alert-primary">
			...
			<h3>Pilihlah calon ketua hima dan wakil ketua hima periode 2022/2023</h3>
		</div>
