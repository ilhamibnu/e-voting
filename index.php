...
<head>
	...
	<title>Pemira Hima JKG 2022</title>
	<link rel="icon" href="dist/img/hikes.png">
	...
	<div class="wrapper">
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item d-none d-sm-inline-block">
					<a href="index.php" class="nav-link">
						<b>Politeknik Kesehatan Kemeskes Surabaya</b>
					</a>
				</li>
			</ul>
		...
		<aside class="main-sidebar sidebar-light-primary elevation-4">
			...
			<a href="index.php" class="brand-link">
				<img src="dist/img/hikes.png" alt="AdminLTE Logo" class="brand-image" style="opacity: .8">
				<span class="brand-text font-weight-light">Pemira Hima JKG 2022</span>
			</a>
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-3 pb-3 mb-3 d-flex">
					<div class="image">
						<img src="dist/img/hikes.png" class="img-circle elevation-2" alt="User Image">
					</div>
					<div class="info">
		...
		<footer class="main-footer">
			...
			Copyright &copy; 2022
			<a target="_blank" href="https://ningbaya.poltekkesdepkes-sby.ac.id/">
				<strong>Jurusan Kesehatan Gigi Poltekkes Kemeskes Surabaya</strong>
			</a>
